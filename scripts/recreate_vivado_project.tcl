...
#
# recreate_vivado_project.tcl: Tcl script for re-creating project 'pk'
#
# Generated by Vivado on Wed Aug 26 00:38:08 +0400 2026
...
#
# 1. This project restoration tcl script (recreate_vivado_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "$origin_dir/vivado/pk.srcs/sources_1/bd/system/system.bd"
#    "$origin_dir/vivado/pk.srcs/constrs_1/new/switches.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado/pk.srcs/sources_1/bd/system/system.bd"]"\
 "[file normalize "$origin_dir/vivado/pk.srcs/constrs_1/new/switches.xdc"]"\
  ]
  foreach ifile $files {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/hls/point_kinetics_hls/point_kinetics_hls/hls/impl/ip"]" $obj
...
set file "[file normalize "$origin_dir/vivado/pk.srcs/constrs_1/new/switches.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/switches.xdc"
